package backend.native.windows;

import backend.native.windows.WindowsAPI.MessageBoxIcon;

// yoshi don't get mad at me this is literally native windows api code
// that YOU probably stole from stack overflow

// even if you didn't it's just windows api code let me use this 😭
