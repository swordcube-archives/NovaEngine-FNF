 ...
 */
 class WindowsAPI {
    ...
    public static function allocConsole() {
        #if windows
        WinAPIBackend.allocConsole();
        WinAPIBackend.clearScreen();
        #end
    }
    ...
    public static function setDarkMode(enable:Bool) {
        #if windows
        WinAPIBackend.setDarkMode(enable);
        #end
    }
    ...
    public static function showMessageBox(caption:String, message:String, icon:MessageBoxIcon = MSG_WARNING) {
        #if windows
        WinAPIBackend.showMessageBox(caption, message, icon);
        #else
    ...
    public static function setConsoleColors(foregroundColor:ConsoleColor = LIGHTGRAY, ?backgroundColor:ConsoleColor = BLACK) {
        ...
        WinAPIBackend.setConsoleColors((bg * 16) + fg);
        #end
    } 
